...
const messages = defineMessages({
	loginAction: {
		id: 'edenlauncher.app.minecraft-account.input.login-action',
		defaultMessage: 'Login',
	},
	addOfflineHeader: {
		id: 'edenlauncher.app.minecraft-account.input.offline.header',
		defaultMessage: 'Add new offline account',
	},
	addAccountHeader: {
		id: 'edenlauncher.app.minecraft-account.input.auth.header',
		defaultMessage: 'Add a Minecraft account',
	},
	chooseSignInMethod: {
		id: 'edenlauncher.app.minecraft-account.input.auth.description',
		defaultMessage: 'Choose how you want to sign in or play.',
	},
	microsoftAccountDescription: {
		id: 'edenlauncher.app.minecraft-account.input.auth.microsoft-description',
		defaultMessage: 'Official account with Minecraft: Java Edition.',
	},
	externalAccountDescription: {
		id: 'edenlauncher.app.minecraft-account.input.auth.external-description',
		defaultMessage: 'Account for servers that support {providerName}.',
	},
	offlineAccount: {
		id: 'edenlauncher.app.minecraft-account.input.auth.offline-label',
		defaultMessage: 'Offline',
	},
	offlineAccountDescription: {
		id: 'edenlauncher.app.minecraft-account.input.auth.offline-description',
		defaultMessage: 'Local profile without authentication tokens.',
	},
	offlineNameLabel: {
		id: 'edenlauncher.app.minecraft-account.input.offline.name.label',
		defaultMessage: 'Enter your player name',
	},
	offlineNamePlaceholder: {
		id: 'edenlauncher.app.minecraft-account.input.offline.name.placeholder',
