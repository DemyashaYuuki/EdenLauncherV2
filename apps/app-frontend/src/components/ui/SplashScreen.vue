...
.gradient-bg {
	...
	width: 100vw;
	background:
		linear-gradient(180deg, rgba(139, 0, 255, 0.24) 0%, rgba(21, 10, 33, 0.56) 97.29%),
		linear-gradient(0deg, rgba(12, 10, 16, 0.72), rgba(12, 10, 16, 0.72));
	z-index: 9997;
}
...
.cube-bg {
	...
	height: 180vh;
	opacity: 0.8;
	background: #0f0f12 url('@/assets/loading/cube.png') center no-repeat;
