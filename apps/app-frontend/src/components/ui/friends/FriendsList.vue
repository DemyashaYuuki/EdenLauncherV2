...
const messages = defineMessages({
	addFriend: {
		...
		defaultMessage: 'Добавить друга',
	},
	addingAFriend: {
		id: 'friends.add-friend.title',
		defaultMessage: 'Добавление друга',
	},
	usernameTitle: {
		id: 'friends.add-friend.username.title',
		defaultMessage: 'Какой ник Modrinth у вашего друга?',
	},
	usernameDescription: {
		id: 'friends.add-friend.username.description',
		defaultMessage: 'Он может отличаться от ника в Minecraft.',
	},
	usernamePlaceholder: {
		id: 'friends.add-friend.username.placeholder',
		defaultMessage: 'Введите ник Modrinth…',
	},
	sendFriendRequest: {
	...
	viewFriendRequests: {
		...
		defaultMessage: 'Запросы в друзья: {count}',
	},
	searchFriends: {
	...
	pending: {
		...
		defaultMessage: 'Ожидают',
	},
	active: {
		id: 'friends.heading.active',
		defaultMessage: 'Играют сейчас',
	},
	online: {
		id: 'friends.heading.online',
		defaultMessage: 'В сети',
	},
	offline: {
		id: 'friends.heading.offline',
		defaultMessage: 'Не в сети',
	},
	noFriendsMatch: {
		id: 'friends.no-friends-match',
		defaultMessage: `По запросу ''{query}'' никого не найдено`,
	},
	signInToAddFriends: {
		id: 'friends.sign-in-to-add-friends',
		defaultMessage: '<link>Войдите в аккаунт Modrinth</link>, чтобы добавлять друзей.',
	},
	addFriendsToShare: {
		id: 'friends.add-friends-to-share',
		defaultMessage: '<link>Добавьте друзей</link>, чтобы видеть их статус.',
	},
})
</script>

<template>
	<ModalWrapper ref="friendInvitesModal" header="Запросы в друзья">
		<p v-if="incomingRequests.length === 0">Новых запросов в друзья нет.</p>
					...
					<div>
						<p class="m-0">
							<template v-if="friend.id === userCredentials?.user_id">
								<span class="text-contrast">{{ friend.username }}</span> отправляет вам запрос в
								друзья
							</template>
							<template v-else>
								Вы отправили запрос пользователю
