...
const messages = defineMessages({
	pageTitle: {
		id: 'edenlauncher.app.settings.external-auth-libraries.title',
		defaultMessage: 'Authentication libraries',
	},
	pageDescription: {
		id: 'edenlauncher.app.settings.external-auth-libraries.description',
		defaultMessage:
			'Choose and install the authentication library used when Minecraft starts with an external player profile.',
	},
	loading: {
		id: 'edenlauncher.app.settings.external-auth-libraries.loading',
		defaultMessage: 'Loading available library versions...',
	},
	loadFailed: {
		id: 'edenlauncher.app.settings.external-auth-libraries.load-failed',
		defaultMessage: 'Could not load authentication libraries: {error}',
	},
	retry: {
		id: 'edenlauncher.app.settings.external-auth-libraries.retry',
		defaultMessage: 'Retry',
	},
	requestServer: {
		id: 'edenlauncher.app.settings.external-auth-libraries.request-server',
		defaultMessage: 'Request from server',
	},
	requestingServer: {
		id: 'edenlauncher.app.settings.external-auth-libraries.requesting-server',
		defaultMessage: 'Requesting...',
	},
	selectedVersion: {
		id: 'edenlauncher.app.settings.external-auth-libraries.selected-version',
		defaultMessage: 'Selected version',
	},
	notSelected: {
		id: 'edenlauncher.app.settings.external-auth-libraries.not-selected',
		defaultMessage: 'Not selected',
	},
	version: {
		id: 'edenlauncher.app.settings.external-auth-libraries.version',
		defaultMessage: 'Version',
	},
	install: {
		id: 'edenlauncher.app.settings.external-auth-libraries.install-selected',
		defaultMessage: 'Install',
	},
	reinstall: {
		id: 'edenlauncher.app.settings.external-auth-libraries.reinstall',
		defaultMessage: 'Reinstall',
	},
	installing: {
		id: 'edenlauncher.app.settings.external-auth-libraries.installing',
		defaultMessage: 'Installing...',
	},
	installed: {
		id: 'edenlauncher.app.settings.external-auth-libraries.installed',
		defaultMessage: '{providerName} library {version} installed',
	},
	noVersions: {
		id: 'edenlauncher.app.settings.external-auth-libraries.no-versions',
		defaultMessage: 'No compatible library versions were found.',
	},
	localOnly: {
		id: 'edenlauncher.app.settings.external-auth-libraries.local-only',
