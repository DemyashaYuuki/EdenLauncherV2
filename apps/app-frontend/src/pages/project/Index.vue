<template>
	<div v-if="data">
		<div class="flex flex-col gap-4 p-6">
			...
			<template v-if="data">
				<details class="project-inline-details">
					<summary>Информация о проекте</summary>
					<div class="project-inline-details__grid">
			...
			<template v-else>Не удалось загрузить данные проекта.</template>
		</div>
