...
export async function initUpdateLauncher(downloadUrl, filename, osType, expectedDigest = null) {
	console.log('[EdenLauncher] Downloading update', filename, osType)
...
export async function createInstanceShortcut(instanceName, instanceId, options = {}) {
	const outputPath = await save({
		defaultPath: `EdenLauncher - ${instanceName}`,
	})
